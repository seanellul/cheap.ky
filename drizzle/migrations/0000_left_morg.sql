...
ALTER TABLE "product_ratings" ADD CONSTRAINT "product_ratings_store_id_stores_id_fk" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "rating_product_store_fingerprint_idx" ON "product_ratings" USING btree ("product_id","store_id","fingerprint");--> statement-breakpoint
